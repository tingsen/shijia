...
class Upload{
    ...
    public function uploadOne($file){
		...
		//修改
		return $info['state'] ? array('state'=>true, 'info'=>'ok','result'=>$info['result'][0]) : $info;
    }
    ...
    public function upload($files='') {
		...
		//修改
		return empty($info) ? array('state'=>false, 'info'=>$this->error) : array('state'=>true, 'info'=>'ok', 'result'=>$info);
    }
